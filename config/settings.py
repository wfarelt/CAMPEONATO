...
INSTALLED_APPS = [
    ...
    'apps.playoffs.apps.PlayoffsConfig',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.core.context_processors.social_links_context',
                'apps.core.context_processors.site_branding_context',
                'apps.notifications.context_processors.notifications_context',
                'apps.playoffs.context_processors.playoffs_context',
            ],
        },
    },
]
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@superligan.fl')
...
WEBPUSH_DEFAULT_ICON = config('WEBPUSH_DEFAULT_ICON', default='/static/tournament/img/favicon.png')
